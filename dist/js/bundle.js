...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _models_MapsAPI__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/MapsAPI */ \"./src/js/models/MapsAPI.js\");\n\ndocument.addEventListener('DOMContentLoaded', function () {\n  var mapElement = document.getElementById('map');\n  _models_MapsAPI__WEBPACK_IMPORTED_MODULE_0__[\"Map\"].loadGoogleMapsApi().then(function (googleMaps) {\n    //Map.createMap(googleMaps, mapElement);\n    new googleMaps.Map(document.querySelector('#map'), {\n      center: {\n        lat: 39.5296,\n        lng: -119.8138\n      },\n      zoom: 12\n    });\n    new googleMaps.Marker({\n      location: {\n        lat: 39.5296,\n        lng: -119.8138\n      },\n      map: mapElement\n    });\n  });\n  /*\n      const yup = new testMap();\n  \n      yup.loadGoogleMapsApi().then(function(googleMaps) {\n          yup.createMap(googleMaps, mapElement);\n          yup.addMarker(googleMaps, mapElement)\n      })\n  \n  \n  */\n});\n\n//# sourceURL=webpack:///./src/js/index.js?");

/***/ }),

/***/ "./src/js/models/MapsAPI.js":
/*!**********************************!*\
  !*** ./src/js/models/MapsAPI.js ***!
  \**********************************/
